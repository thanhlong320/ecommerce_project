...
<input type="hidden" id="flag-index" value=".list-manager-page">
		...
		<table class="table text-center">
			...
			<tbody class="scrollDiv">
				...
				<tr>
					...
					<td><a
						href="<c:url value ="/view/admin/admin-manager/edit-permission.jsp"/>"><i
	...
	<div class="btn-control ml-2 mb-2">
		...
		<a style="color: white; text-decoration: none;"
			href="<c:url value ="/view/admin/admin-manager/add-admin.jsp"/>"
