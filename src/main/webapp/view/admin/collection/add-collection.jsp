...
<input type="hidden" id="flag-index" value=".list-colletion-page">
	<h3 class="ml-4 mt-3">Thêm bộ sưu tập</h3>
	<form action="" class="p-5">
		<div class="form-group">
			<label for="exampleFormControlInput1">Mã bộ sưu tập</label> <input
				type="text" class="form-control" id="exampleFormControlInput1"
				placeholder="Mã bộ sưu tập">
		</div>
		<div class="form-group">
			<label for="exampleFormControlInput1">Tên bộ sưu tập</label> <input
				type="text" class="form-control" id="exampleFormControlInput1"
		...
		<div class="form-group" id="attribute">
			...
			<div class="btn-control ml-2 mb-2">
				...
				<a style="color: white; text-decoration: none;"
					href="<c:url value ="/view/admin/collection/add-product-collection.jsp"/>"
